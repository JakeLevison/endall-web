...
// Proxy POST /integrations/gcal/disconnect. Mirrors the QuickBooks
// disconnect proxy: server-side admin key, tenant from the
...
export async function POST() {
  ...
  try {
    ...
    url.pathname = "/integrations/gcal/disconnect";
    ...
    console.error("gcal disconnect proxy failed:", err);
