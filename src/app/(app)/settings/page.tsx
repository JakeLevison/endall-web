  ...
  return (
    <div className="p-6">
      ...
      <div className="flex flex-col items-center justify-center py-24 text-center">
        ...
        <p className="text-[13px] text-zinc-500 mb-1">Settings</p>
        <p className="text-[11px] text-zinc-600">Account, integrations, team management, and billing configuration.</p>
      </div>
    </div>
  );
}
