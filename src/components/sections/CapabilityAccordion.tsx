...
const CARDS: Card[] = [
  ...
  },
  {
    ...
    icon: <Phone size={18} />,
    title: "Front desk",
    collapsed: "24/7, whatever comes up. Every call answered, every lead qualified.",
    expanded:
      "24/7, whatever comes up. A GC calls at 7 PM and Endall picks up. It sounds like a real person (friendly, professional, natural), asks the right questions, figures out what the caller needs, and books the site visit on your calendar. If it's urgent, you get a text right away. If it's a tire-kicker, the ops layer takes care of it so you don't have to.",
  },
];
